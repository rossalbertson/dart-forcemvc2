...
class MediaType extends MimeType {
  ...
  static final MediaType APPLICATION_ATOM_XML =
      new MediaType.parseMediaType(APPLICATION_ATOM_XML_VALUE);
  ...
  static final MediaType APPLICATION_FORM_URLENCODED =
      new MediaType.parseMediaType(APPLICATION_FORM_URLENCODED_VALUE);

  /**
	 * A String equivalent of {@link MediaType#APPLICATION_FORM_URLENCODED}.
	 */
  static final String APPLICATION_FORM_URLENCODED_VALUE =
  ...
  static final MediaType APPLICATION_JSON =
      new MediaType.parseMediaType(APPLICATION_JSON_VALUE);
  ...
  static final MediaType APPLICATION_JSON_UTF8 =
      new MediaType.parseMediaType(APPLICATION_JSON_UTF8_VALUE);

  /**
	 * A String equivalent of {@link MediaType#APPLICATION_JSON_UTF8}.
	 */
  static final String APPLICATION_JSON_UTF8_VALUE =
  ...
  /**
	 ...
	 */
  static final String APPLICATION_OCTET_STREAM_VALUE =
  ...
  /**
	 ...
	 */
  static final MediaType TEXT_CSV =
      new MediaType.parseMediaType(TEXT_CSV_VALUE);
  ...
  static final MediaType IMAGE_GIF =
      new MediaType.parseMediaType(IMAGE_GIF_VALUE);
  ...
  static final MediaType IMAGE_JPEG =
      new MediaType.parseMediaType(IMAGE_JPEG_VALUE);
  ...
  static final MediaType IMAGE_PNG =
      new MediaType.parseMediaType(IMAGE_PNG_VALUE);
  ...
  /**
	 ...
	 */
  static final MediaType IMAGE_WEBP =
      new MediaType.parseMediaType(IMAGE_WEBP_VALUE);
  ...
  static final MediaType MULTIPART_FORM_DATA =
      new MediaType.parseMediaType(MULTIPART_FORM_DATA_VALUE);
  ...
  static final MediaType TEXT_HTML =
      new MediaType.parseMediaType(TEXT_HTML_VALUE);
  ...
  static final MediaType TEXT_PLAIN =
      new MediaType.parseMediaType(TEXT_PLAIN_VALUE);
  ...
  static final MediaType TEXT_XML =
      new MediaType.parseMediaType(TEXT_XML_VALUE);
  ...
  MediaType(String type,
      {String subtype, String charset, Map<String, String> parameters})
      : super(type, subtype: subtype, charset: charset, parameters: parameters);

  factory MediaType.parseMediaType(String mediaType) {
    MimeType type;
    type = MimeTypeUtils.parseMimeType(mediaType);
    return new MediaType(type.getType(),
        subtype: type.getSubtype(), parameters: type.getParameters());
  }
  ...
  MediaType copyQualityValue(MediaType mediaType) {
    ...
    params[PARAM_QUALITY_FACTOR] =
        mediaType.getParameters()[PARAM_QUALITY_FACTOR];
