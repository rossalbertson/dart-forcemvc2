...
class MustacheRender extends ForceViewRender {
  ...
  MustacheRender(ServingAssistent servingAssistent,
      [views = "../views/", clientFiles = "../build/web/", clientServe = true])
      : super(servingAssistent, views, clientFiles, clientServe);
  ...
  String _reviewTemplate(String result) {
    result =
        result.replaceAll("${delimiter.opening}&amp;", "${delimiter.opening}&");
    return result;
  }
